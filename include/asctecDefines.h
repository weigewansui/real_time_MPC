...
#define ACIMT_UPDATEVARTABLE 		  	0x02 // not used
#define ACIMT_GETVARTABLEINFO			0x03 //used

#define ACIMT_REQUESTCMDTABLEENTRIES 	0x02
#define ACIMT_UPDATECMDTABLE 		  	0x03 // not used
#define ACIMT_GETCMDTABLEINFO			0x04 // used

#define ACIMT_REQUESTPARAMTABLEENTRIES 	0x05
#define ACIMT_UPDATEPARAMTABLE 		  	0x06 // not used
#define ACIMT_GETPARAMTABLEINFO			0x07 //used
